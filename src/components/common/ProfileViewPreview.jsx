...
const ProfileViewPreview = (props) => {
    const user = props.user;

    return (
        <div id="profile"
             className="w-full rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75">
            <div className="p-4 md:p-12 text-center lg:text-left">
                {/* Image for mobile view*/}
                <h1 className="text-3xl font-bold pt-8 lg:pt-0">{user.firstName + " " + user.lastName}</h1>
...
export default ProfileViewPreview;